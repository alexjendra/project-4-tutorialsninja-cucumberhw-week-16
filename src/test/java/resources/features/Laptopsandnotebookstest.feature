...
Feature: Laptops & Notebooks Feature
  ...
  @author_Khushbu_Raval @sanity @smoke
  ...
  Scenario: User should see the products as price high to low
    ...
    And I enter first name "Khushi" in billing details
    And I enter last name "Raval" in billing details
    And I enter email address in billing details
    And I enter phone number "07445762764" in the billing details
    And I enter billing address "7 stanley Road" in the billing details
    And I enter city "Harrow" in the billing details
    And I enter postcode "HA28FB"  in the billing details
